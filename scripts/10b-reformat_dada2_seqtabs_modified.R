...
# ---- use functions ----
setwd("~/Desktop/taxass_lp16s_reseq2/")

# 1. Import dada2 sequence table
load("lp2017-2019watercolumn16sreseq2_seqtab_nochim.rda")
dim(seqtab_nochim)

# 2. Make fasta file
seqIDs <- make.fasta.file(dadatable = seqtab_nochim, fasta.path = "otus.fasta")
...
make.abund.file(OTUs = seqtab_nochim, FilePath = "otus.abund")

make.count.file(Count = read.count, FilePath = "otus.count")
