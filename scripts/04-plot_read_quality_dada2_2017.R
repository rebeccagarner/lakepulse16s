...
for (i in 1:round(length_fwdreads/25)) {
  pdf(paste0("lp2017watercolumn16s_fwdreads_quality_plots", (i*25-24), "-", (i*25), ".pdf"), width = 20, height = 20)
...
for (i in 1:round(length_revreads/25)) {
  pdf(paste0("lp2017watercolumn16s_revreads_quality_plots", (i*25-24), "-", (i*25), ".pdf"), width = 20, height = 20)
