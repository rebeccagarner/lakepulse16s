...
pdf("lp2017watercolumn16s_fwdreads_errors_plots.pdf")
plotErrors(err_forward_reads, nominalQ = TRUE)
dev.off()

err_reverse_reads <- learnErrors(filtered_reverse_reads, nbases = 1e8, multithread = TRUE)
pdf("lp2017watercolumn16s_revreads_errors_plots.pdf")
...
dim(seqtab)
save(seqtab, file = "lp2017watercolumn16s_seqtab.rda")
...
write.table(summary_tab, "lp2017watercolumn16s_dada2_readtracking.tsv", quote = FALSE, sep = "\t", col.names = NA)
